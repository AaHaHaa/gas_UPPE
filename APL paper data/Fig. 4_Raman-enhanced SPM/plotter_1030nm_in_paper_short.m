...
load('Raman_enhanced_SPM_1030nm_paper_short.mat');
...
xlim([-4,4]);
xlabel('Time (ps)');
print(gcf,'pulse_1030nm_short.pdf','-dpdf');
...
print(gcf,'QEevolution_1030nm_short.pdf','-dpdf');
...
print(gcf,'QEevolution_1030nm_short_closeview.pdf','-dpdf');