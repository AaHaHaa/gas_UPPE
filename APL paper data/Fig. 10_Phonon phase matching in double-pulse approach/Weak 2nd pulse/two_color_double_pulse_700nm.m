...
addpath('../../../../MMTools/gas_UPPE/user_helpers','../../../../MMTools/gas_UPPE/broadband UPPE algorithm');
...
sim.progress_bar_name = '0.7,2 LWIR';
...
for i = 1:10
    ...
    %%
    save(sprintf('two_color_lossy%u_0.70um%uuJ_%ups_2um%uuJ_%ups_%uumID_%ubar_L%ucm.mat',i,total_energy1/1e3,tfwhm2_1,total_energy2/1e3,tfwhm2_2,gas.core_radius*1e6*2,gas.pressure/1e5,fiber.L0*100),'-v7.3');
end