...
for ii = 1:10
    load(sprintf('two_color_lossy%u_0.70um2000uJ_10ps_2um10uJ_10ps_300umID_20bar_L100cm.mat',ii));
...
photon_number_S_all     = zeros(101,10);
for ii = 1:10
    load(sprintf('two_color_lossy%u_1.09um2000uJ_10ps_2um10uJ_10ps_300umID_20bar_L100cm.mat',ii));
