...
n_Ag = calc_n_Ag(gas_wavelength*1e9,sim.gpu_yes,sim.cuda_dir_path,gas.wavelength_order);
...
target_n_out = interp1(gas_f,n_Ag,c*1e-9/target_wavelength); % for real n_out
