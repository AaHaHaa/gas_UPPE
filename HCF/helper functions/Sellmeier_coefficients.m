...
switch material
    ...
    case 'Al2O3-o' % From https://refractiveindex.info/?shelf=main&book=Al2O3&page=Malitson-o
                   % n^2 - 1 = ...
                   % At 20 degree Celsius
        a = [1.4313493, 0.65054713, 5.3414021];
        b = [0.0726631,  0.1193242, 18.028251];
    case 'Al2O3-e' % From https://refractiveindex.info/?shelf=main&book=Al2O3&page=Malitson-e
                   % n^2 - 1 = ...
                   % At 20 degree Celsius
        a = [1.5039759, 0.55069141, 6.5927379];
        b = [0.0740288,  0.1216529, 20.072248];
