% This code solves for the propagation constant of a Kagome fiber.
%
...
wavelength = c./f; % nm
target_wavelength = 1550; % nm; the spatial profile is generated only at the target wavelength
