__global__ void calculate_tensors(double* QR, const double* normalized_fields, const int num_modes, const int Nx, const double* r, const double dr, const double dtheta) {
