function sim_betas = calc_sim_betas(fiber,dt,Omega,fields)
...
[betas_Taylor_coeff,~,mu] = polyfit(fftshift_Omega(omegas_idx_near_pulse),real(fiber.betas(omegas_idx_near_pulse,1)),fit_order);
