function [A1, dummy_a5_1,...
          opt_deltaZ,success]= stepping_MPA_gradient_pressure(A0, dummy_a5_1,...
                                                              sim, gas, gas_eqn,...
...
if sim.Raman_model ~= 0
    ...
    switch gas.model
        case 0
            ...
            sponRS_Gamma = fft(gas_eqn.R.*sponRS,2*gas_eqn.Nt-1,1);
        ...
        case 1
            ...
            sponRS_Gamma = fft(gas_eqn.R.*sponRS,gas_eqn.Nt,1).*gas_eqn.phase_shift;
    end
else
    sponRS_Gamma = [];
end
