...
% Compared to Fig. 4 in the article, the simulated parameters are modified 
% to demonstrate the FWM-related gain effect.
...
%%
save('Raman_enhanced_SPM_1030nm_supplement.mat');