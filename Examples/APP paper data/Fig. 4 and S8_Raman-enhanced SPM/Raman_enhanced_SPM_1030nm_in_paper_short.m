% This code simulates the Raman-enhanced SPM effect with a 200-fs 
...
sim.adaptive_deltaZ.max_deltaZ = 1e-5;
...
[~,chirped_pulse] = func.General( tfwhm(7),ifftshift(f*2*pi),ifft(input_pulse.fields),1 );
...
%%
save('Raman_enhanced_SPM_1030nm_paper_short.mat');