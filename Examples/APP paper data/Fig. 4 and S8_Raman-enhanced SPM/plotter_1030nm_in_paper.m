...
load('Raman_enhanced_SPM_1030nm_paper.mat');
...
print(gcf,'SPM_1030nm_paper.pdf','-dpdf','-bestfit');

Stokes_pulse = gaussian_spectral_filter(prop_output{9,2}, sim.f0, c/(c/pump_wavelength-gas.H2.V.omega(2)/2/pi)*1e9, 500, 5);
...
set(gca,'fontsize',25);
legend('TL','D');
print(gcf,'dechirped_1030nm_paper.pdf','-dpdf');