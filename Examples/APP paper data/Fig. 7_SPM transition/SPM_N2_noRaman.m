...
% duration due to varying Raman-induced SPM in N2.
%
% This code excludes the Raman nonlinearity.
...
wavelength_range = [0.6,1.5]*1e-6; % m
Nt = 2^14;
