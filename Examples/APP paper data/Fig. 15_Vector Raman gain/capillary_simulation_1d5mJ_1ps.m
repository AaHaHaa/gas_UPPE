% This code simulates the initial Raman growth with a 1.5-mJ and 1-ps pump
% pulse.
% In this situation, the cross-linearly-polarized rotational Raman S(1)
% will dominate.
...
sim.progress_bar_name = 'Raman growth (1.5mJ, 1ps)';
