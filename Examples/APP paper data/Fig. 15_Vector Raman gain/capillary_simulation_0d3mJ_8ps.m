% This code simulates the initial Raman growth with a 0.3-mJ and 8-ps pump
% pulse.
% In this situation, the co-linearly-polarized vibrational Raman Q(1)
% will dominate.
...
sim.progress_bar_name = 'Raman growth (0.3mJ, 8ps)';
...
idx = f>165 & f<170;
max_plot = max(spectrum(idx,1))*1.05;
...
legend('x','y');
print(gcf,'capillary_PSD_0d3mJ_8ps.pdf','-dpdf');