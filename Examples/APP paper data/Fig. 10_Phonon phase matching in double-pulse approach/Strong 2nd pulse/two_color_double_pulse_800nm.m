...
% pulse at 800 nm.
% At this first-pulse wavelength, phonon amplification is preferred in the
% second pulse.
...
sim.progress_bar_name = '0.8,2 LWIR';
...
fiber.betas = fiber.betas - 1i*log(0.8)/2;

%% Initial condition and Propagate
tfwhm1_1 = 0.05; % ps
total_energy1 = 2000e3; % nJ
pump_wavelength1 = 800e-9; % m
...
%%
save(sprintf('two_color_lossy_0.80um%uuJ_%ups_2um%uuJ_%ups_%uumID_%uatm_L%ucm.mat',total_energy1/1e3,tfwhm2_1,total_energy2/1e3,tfwhm2_2,gas.core_radius*1e6*2,gas.pressure/1.01325e5,fiber.L0*100),'-v7.3');