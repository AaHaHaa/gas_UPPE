...
%%
load('two_color_lossy1_0.70um2000uJ_10ps_2um5000uJ_10ps_300umID_20bar_L100cm.mat');
...
%%
range = {Nt/2:Nt,1:Nt/2};
probe_pulse.fields = prop_output.fields(:,1,41);
probe_pulse.dt = dt;
...
[optimal_value,dechirped_FWHM,dechirped_field,grating_size,mirror_size] = pulse_compressor('Treacy-beta2',pi/6,sim.lambda0*1e9,t,probe_pulse.fields,1e-3/100,false,false,-1);
...
legend('TL','D');
print(gcf,'dechirped_pulse_S (700nm).eps','-depsc');

%%
load('two_color_lossy1_1.09um2000uJ_10ps_2um5000uJ_10ps_300umID_20bar_L100cm.mat');
...
set(gca,'fontsize',50,'YTick',[]); %set(gcf,'Color','None');
legend('TL','D');
print(gcf,'dechirped_pulse_S (1090nm).eps','-depsc');