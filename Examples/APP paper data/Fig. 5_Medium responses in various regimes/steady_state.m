% This code plots the Raman-induced index change excited by a 10-ns pulse,
% which is in the steady-state Raman regime.
...
ylim([-1.15,1.15]);
xlim([-1,1]*tfwhm1*2/1e3);
xlabel('Time (ns)');
set(gca,'fontsize',25);
print('medium_steady_state.pdf','-dpdf');