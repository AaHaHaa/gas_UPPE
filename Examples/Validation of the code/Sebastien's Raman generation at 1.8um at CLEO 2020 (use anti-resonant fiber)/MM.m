...
input_field.fields = input_field.fields.*[sqrt(2),1,1e-3]/sqrt(3);
...
gas.t_tube = 310e-9; % m; the tube's wall thickness of anti-resonant fibers
...
%%
save(sprintf('MM_%ubar.mat',gas.pressure/1.01325e5));