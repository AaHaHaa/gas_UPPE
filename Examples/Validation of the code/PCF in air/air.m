...
sim.progress_bar_name = 'air';

num_save = 1;
fiber.L0 = 14; % m; propagation length
...
gas.fiber_type = 'Ag_coating'; % 'Ag_coating', 'no_coating', 'MWLW_coating' coating types for capillaries
