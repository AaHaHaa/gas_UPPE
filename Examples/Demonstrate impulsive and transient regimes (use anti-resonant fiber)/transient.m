% This code shows the Raman-induced index change in the transient regime.
...
wavelength_range = [0.5,5]*1e-6; % m
Nt = 2^11;
[f0,f_range,time_window,dt] = find_tw_f0(c./wavelength_range,Nt);

sim.f0 = f0;
%sim.progress_bar = false;
sim.progress_bar_name = 'transient';
sim.gpu_yes = false;

num_save = 100;
fiber.L0 = 0.4; % m; propagation length
...
% sim.include_Raman = true; Use the Raman model (exist only in Raman-active gases)
...
gas.pressure = 5*1.013e5; % Pa; gas pressure
...
fiber.betas = real(fiber.betas); % ignore the loss to simply demonstrate the Raman-induced index change in this code
